...
<div class="container">
    <div class="p-5 mb-4">
        ...
        <p class="fs-4">Este es un proyecto CRUD (Create, Read, Update, Delete) con fines educativos para el programa "Codo a Codo", realizado por <a target="_blank" href="https://www.youtube.com/c/CharlyCimino"> Prof. Carlos Cimino</a>, tarea realizada por Cristian Sagardia.</p>
